                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            if( !empty( $image ) ): ?>
                                                ...
                                                <a href="<?php echo $artist['artist_link'] ?>">
                                        ...
                                        <div class="col-12 text-left pt-2">
                                            ...
                                            <a href="<?php echo $artist['artist_link'] ?>" class="mx-1 hvr-grow-shadow btn btn-dark"> ARTWORK</a>
                                            <a href="<?php echo $artist['bio_link']?>" class="mx-1 hvr-grow-shadow btn btn-light"> BIO</a>
                                        </div>
                                    </div>
