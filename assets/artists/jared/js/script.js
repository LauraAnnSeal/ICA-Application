...
var markerOne = L.marker([-1.285024, 36.826006], {icon: building}).addTo(mymap);
...
var markerSix = L.marker([-1.262301, 36.879242], {icon: bookBlinking}).addTo(mymap);
...
function on() 
{
    ...
    document.getElementById("contentOverlay").scrollTop = 0;
...
markerSix.addEventListener('click', () =>  {
    on();
    audio.pause();
            ...
            `<div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <button id="GoToPointOne" class="travel btn btn-danger my-5">Click Here To Travel To Kenya National Archive.</button><br><br>
                    </div>
                </div>
            </div>`;

        var clickPointOne = document.getElementById("GoToPointOne");   

        clickPointOne.addEventListener('click', () => 
            {
                document.getElementById("contentOverlay").scrollTop = 0;
                document.body.scrollTop = 0;
                mymap.setView([-1.285024, 36.826006], 14);
                ...
                overlayText.innerHTML = 
                    `<div class="container-fluid">
                        ...
                        <div class="col-12 text-center">
                            ...
                            <button id="GoToPointThree" class="travel btn btn-danger my-5">Click Here To Travel To 37 Muindi Mbingu Street</button> <br><br>
                        </div>
                    </div>
                    </div>`;
                    ...
                    `<div class="container-fluid">
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <button id="GoToPointTwo" class="travel btn btn-danger my-5">Click Here To Travel To The Kibera Slum</button> <br> <br>
                            </div>
                        </div>
                    </div>`;
                            ...
                            `<div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        <p id="contentText">
                                        <iframe id="video2" class="videos" src="https://player.vimeo.com/video/489429948" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
                                        </p>
                                        <button id="GoToPointEight" class="travel btn btn-danger my-5">Click Here To Travel To Viwanda.</button><br><br>
                                    </div>
                                </div>
                            </div>`;
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                           ...
                                           These colonial designs induce a whole series of effects in the urban public sphere; they have crystallised into institutions and inform individual behaviours while at the same time acting as grids for the perception and evaluation of our everyday city life. For example: it is just not practical to sit on benches within the Nairobi Central Business District (Jevanjee Gardens) to rest or read in public parks, as a social practice like it is so common in other cities around the world. There is simply no time for it, as the time is taken up by walking. <br> <br>
                                            ...
                                            <button id="GoToPointSix" class="travel btn btn-warning my-5">Click Here To View Entire Map.</button> <br><br>
                                        </div>
                                    </div>
                                </div>`;
                                var clickPointHome = document.getElementById("GoToPointSix");
